...
const Newsletter = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch("https://help-desk-backend-6ob3.onrender.com/send-feedback", {
                method: "POST",
    ...
    return (
        <div>
            <div>
                ...
                <div className="w-full space-y-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            className="w-full block py-2 bg-blue hover:bg-cream rounded-sm text-white cursor-pointer font-semibold mt-3"
                        >
                            Feedeback
                        </button>
                    </form>
            ...
            <div className="mt-20">
                ...
                <div className="w-full space-y-4">
                    <button type="submit" onClick={handleNotification} className="w-full flex justify-center items-center py-2 bg-blue hover:bg-cream rounded-sm text-white cursor-pointer font-semibold">
